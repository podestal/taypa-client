      ...
      <div className="max-w-7xl mx-auto w-full h-full flex flex-col">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-4 md:gap-6 lg:gap-8 items-start overflow-y-auto scrollable-content">
          ...
          <div ref={optionsRef} className="space-y-1 sm:space-y-2 md:space-y-3 order-2 lg:order-2">
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-2 sm:mb-4 md:mb-6 text-center">Elige tu hamburguesa</h2>
            
            {burgerTypes.map((option, index) => (
              <div
                key={option.id}
                className={`burger-option bg-white/20 backdrop-blur-sm rounded-md sm:rounded-lg md:rounded-xl p-2 sm:p-3 md:p-4 hover:bg-white/30 transition-all duration-300 cursor-pointer border-2 ${
