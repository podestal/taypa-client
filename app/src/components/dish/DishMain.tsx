...
//   const { data: dishes, isLoading, error, isSuccess } = useGetDishesByCategory(selectedCategory)
...
//   if (isSuccess) return <div>Dishes</div>

  return (
    <div>{selectedCategory} sadasdasd</div>
  )
}
